...
class NewsletterStory(models.Model):
    ...
    company_unit_title = models.CharField(max_length=300, blank=True, help_text="نام واحد/مرکز تخصصی مرتبط با این خبر؛ فقط عنوان سازمانی ثبت‌شده.")
    company_unit_slug = models.SlugField(max_length=180, blank=True, help_text="شناسه پایدار پرونده واحد تخصصی شرکت.")
    company_activity_status = models.CharField(max_length=40, blank=True, default="", help_text="وضعیت فعالیت: پژوهش، مطالعه، طراحی، پایلوت، تولید یا آینده.")
    company_project_title = models.CharField(max_length=300, blank=True, help_text="پروژه مادر مرتبط، در صورت ثبت.")
    company_activity_content = models.TextField(blank=True, help_text="متن ساختاریافته پرونده فعالیت شرکت.")
...
class NewsletterSubmission(models.Model):
    ...
    subject = models.CharField(max_length=500, verbose_name="عنوان فعالیت شرکت")
    body = models.TextField(verbose_name="شرح فعالیت شرکت", help_text="فقط واقعیت‌ها، فعالیت‌ها، پژوهش‌ها، پروژه‌ها و خروجی‌های ثبت‌شده شرکت.")
    ...
    occasion_code = models.CharField(max_length=80, blank=True, help_text="اختیاری؛ فقط برای دسته‌بندی داخلی فعالیت شرکت.")
    company_target_paths = models.TextField(blank=True, help_text="صفحات واقعی شرکت برای اتصال محتوا؛ فقط مسیرهای /company/.")
    company_unit_title = models.CharField(max_length=300, blank=True, help_text="واحد/مرکز تخصصی که این خبر باید برای آن پرونده بسازد.")
    company_unit_slug = models.SlugField(max_length=180, blank=True, help_text="شناسه پایدار واحد؛ در صورت خالی بودن توسط سیستم ساخته می‌شود.")
    company_activity_status = models.CharField(max_length=40, blank=True, default="پژوهش", help_text="پژوهش، مطالعه، طراحی، پایلوت، تولید یا آینده.")
    company_project_title = models.CharField(max_length=300, blank=True, help_text="نام پروژه مادر مرتبط.")
